...
import { Text, Button, TextInput, HelperText, Divider, Avatar } from 'react-native-paper';
      ...
      <View style={styles.section}>
        ...
        {editing ? (
          ...
          <View style={styles.nameRow}>
            ...
            <Button compact mode="text" onPress={() => setEditing(true)}>
              Edit
            </Button>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  label: { color: '#9e9e9e', marginBottom: 6, letterSpacing: 0.8 },
